...
namespace DotNet.Retire.Packages.Tool.Extensions
{
    /// <summary>
    /// Shamefully copied from https://github.com/madskristensen/BundlerMinifier/blob/master/src/BundlerMinifier.Core/StringExtensions.cs
    /// </summary>
