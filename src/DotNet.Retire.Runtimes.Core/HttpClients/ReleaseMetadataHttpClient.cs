...
using DotNet.Retire.Runtimes.Core.HttpClients.Models.Channels;
using Newtonsoft.Json;

[assembly: InternalsVisibleTo("DotNet.Retire.Runtimes.Core.Tests")]
namespace DotNet.Retire.Runtimes.Core.HttpClients
{
